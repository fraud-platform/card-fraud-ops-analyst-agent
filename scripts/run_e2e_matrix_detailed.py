...
HTML_REPORT_PATH = Path("htmlcov/e2e-scenarios-report.html")
STAGE_AUDIT_PATH = Path("htmlcov/stage-audit-report.json")
TIMEOUT = 120
...
def _parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--html-report", type=Path, default=HTML_REPORT_PATH)
    parser.add_argument("--stage-audit", type=Path, default=STAGE_AUDIT_PATH)
